    ...
    <div className="relative w-full min-h-screen px-6 md:px-10 bg-gradient-to-br from-rose-50 via-white to-sky-50 overflow-hidden flex flex-col items-center">
      ...
      <div className="container mx-auto px-4 py-12 h-auto flex flex-col md:flex-row items-center justify-center gap-8">
        ...
        {/* Right side - Image showcase */}
          ...
          <div
            className={`absolute top-[4%] left-[10%] w-[160px] h-[180px] md:w-[180px] md:h-[220px] z-10 transition-all duration-500 ${activeImage === 0 ? "scale-110 shadow-xl" : "scale-100 opacity-80"}`}
          >
          ...
          <div
            className={`absolute top-[20%] right-[5%] w-[160px] h-[180px] md:w-[180px] md:h-[220px] z-10 transition-all duration-500 ${activeImage === 1 ? "scale-110 shadow-xl" : "scale-100 opacity-80"}`}
          >
            <div className="w-full h-full relative rounded-xl overflow-hidden shadow-lg">
          ...
          <div
            className={`absolute bottom-[15%] left-[3%] w-[160px] h-[180px] md:w-[180px] md:h-[220px] z-10 transition-all duration-500 ${activeImage === 2 ? "scale-110 shadow-xl" : "scale-100 opacity-80"}`}
          >
            <div className="w-full h-full relative rounded-xl overflow-hidden shadow-lg">
          ...
          <div
            className={`absolute bottom-[4%] right-[1%] w-[160px] h-[180px] md:w-[180px] md:h-[220px] z-10 transition-all duration-500 ${activeImage === 3 ? "scale-110 shadow-xl" : "scale-100 opacity-80"}`}
          >
            <div className="w-full h-full relative rounded-xl overflow-hidden shadow-lg">
        ...
        <div className="w-full md:w-[450px] md:hidden h-auto flex justify-center relative">
          {/* Main featured product */}
          <div className="w-[250px] md:w-[350px] h-auto relative rounded-2xl overflow-hidden shadow-2xl">
