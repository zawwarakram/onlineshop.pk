    ...
    <section className="py-16 bg-white overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="relative bg-gradient-to-r from-rose-500 to-pink-600 rounded-2xl overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center p-4 md:p-12">
            <div className="text-white space-y-6">
              ...
              <p className="text-white/80 max-w-md">
                Don't miss out on our biggest sale of the season. Get premium
              ...
              <div className="flex space-x-4">
                <div className="flex flex-col items-center">
                  <div className="bg-white text-rose-600 rounded-lg w-13 md:w-16 h-16 flex items-center justify-center text-2xl font-bold">
            ...
            <div className="relative  h-64 md:h-auto">
              <Image
                src="https://media.istockphoto.com/id/1081900212/photo/woman-is-showing-bags-with-purchases-in-store.jpg?s=612x612&w=0&k=20&c=8suXaJAWgbHYS7N5u8fMwO2eGtu0P7_H0sWsvR00Vsw="
                alt="Special Offer"
                fill
